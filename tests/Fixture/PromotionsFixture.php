...
class PromotionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'effect' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-14 18:06:09',
                'modified' => '2018-06-14 18:06:09'
            ],
        ];
        parent::init();
    }
