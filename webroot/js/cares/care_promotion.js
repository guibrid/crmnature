$(function () {
  ...
  $("#promotion_id").bind('input', function () { //Si on ajout une promotion
    ...
    if($("#promotion_id option:selected").attr("data-effect")) { //on detect une formule
      ...
      $("#price_value").val($("#price_value").val()-promotion_value); // On recalcul le prix du soin avec la formule
      ...
      $("#balance").val( $("#old_balance").val() - $("#price_value").val() ); // On reinitialise la balance initiale
    }
  });
