...
class CaresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_price_id' => ['type' => 'index', 'columns' => ['price_id'], 'length' => []],
            'fk_payment_id' => ['type' => 'index', 'columns' => ['payment_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price_id' => 1,
                'payment_id' => 1,
                'created' => '2018-05-14 10:10:45',
                'modified' => '2018-05-14 10:10:45'
            ],
        ];
        parent::init();
    }
