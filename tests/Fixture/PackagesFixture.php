...
class PackagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'real_value' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'real_value' => 1,
                'created' => '2018-06-14 18:05:46',
                'modified' => '2018-06-14 18:05:46'
            ],
        ];
        parent::init();
    }
